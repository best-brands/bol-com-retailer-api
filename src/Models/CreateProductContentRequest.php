 ...
 */
final class CreateProductContentRequest extends AModel
{
    ...
    /**
     * A list of supplied products and their attributes. Attributes that are required for publishing products online
     * will be mentioned in the data model.
     * @var ProductContent[]
     */
    ...
    {
        $this->_checkIfPureArray($productContents, ProductContent::class);
